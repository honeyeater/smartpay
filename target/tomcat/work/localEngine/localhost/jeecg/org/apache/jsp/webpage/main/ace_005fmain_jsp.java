...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path;
      ...
      out.write("\t\t<!-- update-start--Author: dangzhenghui Date:20170608 for: TASK #2088 【图标问题】首页风格图标统一 -->\n");
      out.write("\t\t<link href=\"plug-in-ui/hplus/css/font-awesome.min.css?v=4.4.0\" rel=\"stylesheet\">\n");
      out.write("\t\t<!-- update-end--Author: dangzhenghui Date:20160812 for: TASK #2088 【图标问题】首页风格图标统一-->\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</a>\n");
      out.write("\t\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t<!--update--end--author:zhangjiaqiang date:20170314 for: 修订公告信息显示异常 -->\n");
      out.write("\t\t\t\t\t\t\t\t<li>\n");
  ...
  private boolean _jspx_meth_t_005fmutiLang_005f13(PageContext _jspx_page_context)
    ...
    // /webpage/main/ace_main.jsp(570,22) name = langKey type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
