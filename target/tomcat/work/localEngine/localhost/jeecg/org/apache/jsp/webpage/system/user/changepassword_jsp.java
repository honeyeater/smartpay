...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path;
  ...
  private boolean _jspx_meth_t_005fbase_005f0(PageContext _jspx_page_context)
    ...
    // /webpage/system/user/changepassword.jsp(7,0) name = type type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fformvalid_005f0(PageContext _jspx_page_context)
    ...
    // /webpage/system/user/changepassword.jsp(10,0) name = formid type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fformvalid_005f0.setFormid("formobj");
    // /webpage/system/user/changepassword.jsp(10,0) name = refresh type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fformvalid_005f0.setRefresh(new Boolean(false));
    // /webpage/system/user/changepassword.jsp(10,0) name = dialog type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fformvalid_005f0.setDialog(true);
    // /webpage/system/user/changepassword.jsp(10,0) name = action type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fformvalid_005f0.setAction("userController.do?savenewpwd");
    // /webpage/system/user/changepassword.jsp(10,0) name = usePlugin type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fformvalid_005f0.setUsePlugin("password");
    // /webpage/system/user/changepassword.jsp(10,0) name = layout type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_t_005fformvalid_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("\t\t<tbody>\n");
        out.write("\t\t\t<tr>\n");
        out.write("\t\t\t\t<td align=\"right\" width=\"10%\"><span class=\"filedzt\">原密码:</span></td>\n");
        out.write("\t\t\t\t<td class=\"value\"><input type=\"password\" value=\"\" name=\"password\" class=\"inputxt\" datatype=\"*\" errormsg=\"请输入原密码\" /> <span class=\"Validform_checktip\"> 请输入原密码 </span></td>\n");
        out.write("\t\t\t</tr>\n");
        out.write("\t\t\t<tr>\n");
        ...
        out.write("\t\t\t\t<td class=\"value\"><input id=\"newpassword\" type=\"password\" recheck=\"newpassword\" class=\"inputxt\" datatype=\"*6-18\" errormsg=\"两次输入的密码不一致！\"> <span class=\"Validform_checktip\"></span></td>\n");
        out.write("\t\t\t</tr>\n");
        out.write("\t\t</tbody>\n");
        out.write("\t</table>\n");
