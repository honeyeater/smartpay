...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path;
      ...
      out.write("<!-- update-begin--Author:xuelin  Date:20170428 for：#1755 【美化】用户分析报表，多tab格式，是否可以美化  需要改底层-------------------- -->\n");
      ...
      if (_jspx_meth_t_005ftabs_005f0(_jspx_page_context))
        return;
      out.write("\n");
      out.write("<!-- update-end--Author:xuelin  Date:20170428 for：#1755 【美化】用户分析报表，多tab格式，是否可以美化  需要改底层-------------------- -->\n");
      out.write("<!-- update-begin--Author:xuelin  Date:20170329 for：[#1823]【bug】报表点击打印后，页面乱的问题解决-------------------- -->\n");
      out.write("<script type=\"text/javascript\">\n");
      out.write("\t\t$(document).ready(function() {\n");
      out.write("\t\t\t//为不需要打印的元素添加打印隐藏识别类\n");
      out.write("\t\t\t$(\".tabs-header\").addClass(\"no-print\");\n");
      out.write("\t\t});\n");
      out.write("\t\t/* update-begin--Author:xuelin  Date:20170427 for：#1755 【美化】用户分析报表，多tab格式，是否可以美化 / 优化[#1823]【bug】隐藏的Tab打印后也错乱-------------------- */\n");
      out.write("\t\t$(window).resize(function(){\n");
      out.write("\t\t\tvar tabs = $('#tt').tabs('tabs');\n");
      out.write("\t\t\tfor(var i = 0; i < tabs.length; i++){\n");
      out.write("\t\t\t\ttabs[i].panel('refresh');\n");
      out.write("\t\t\t}\n");
      out.write("\t\t});\t\t\n");
      out.write("\t\t/* update-end--Author:xuelin  Date:20170427 for：#1755 【美化】用户分析报表，多tab格式，是否可以美化/ 优化[#1823]【bug】隐藏的Tab打印后也错乱-------------------- */\n");
      out.write("</script>\n");
  ...
  private boolean _jspx_meth_t_005fbase_005f0(PageContext _jspx_page_context)
    ...
    // /webpage/system/log/statisticTabs.jsp(5,0) name = type type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005ftabs_005f0(PageContext _jspx_page_context)
    ...
    // /webpage/system/log/statisticTabs.jsp(8,0) name = id type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005ftabs_005f0.setId("tt");
    // /webpage/system/log/statisticTabs.jsp(8,0) name = iframe type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005ftab_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005ftabs_005f0, PageContext _jspx_page_context)
    ...
    _jspx_th_t_005ftab_005f0.setIcon("fa fa-line-chart");
  ...
  private boolean _jspx_meth_t_005ftab_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005ftabs_005f0, PageContext _jspx_page_context)
    ...
    _jspx_th_t_005ftab_005f1.setIcon("fa fa-pie-chart");
  ...
  private boolean _jspx_meth_t_005ftab_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_t_005ftabs_005f0, PageContext _jspx_page_context)
    ...
    // /webpage/system/log/statisticTabs.jsp(11,1) name = href type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005ftab_005f2.setHref("logController.do?userBroswer&reportType=column");
    // /webpage/system/log/statisticTabs.jsp(11,1) name = icon type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005ftab_005f2.setIcon("fa fa-bar-chart");
    // /webpage/system/log/statisticTabs.jsp(11,1) name = title type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005ftab_005f2.setTitle("user.analysis.histogram");
    // /webpage/system/log/statisticTabs.jsp(11,1) name = id type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
