...
public final class updatepwdMain_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/webpage/smp/user/updatepwd.jsp");
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path;
      ...
      out.write("\n");
      out.write("\n");
      out.write("<div class=\"container\" id=\"updpwd\">\n");
      out.write("    <div class=\"row\" style=\"margin-top: 20px\">\n");
      out.write("        <form class=\"required-validate\" method=\"post\" onsubmit=\"return validateCallback(this);\" id=\"updpwdForm\">\n");
      out.write("            <div class=\"col-sm-1\"></div>\n");
      out.write("            <div class=\"col-sm-10\">\n");
      out.write("                <div class=\"col-lg-6\">\n");
      out.write("                    <div class=\"alert alert-info\" role=\"alert\" style=\"width: 100%;text-align: center\">\n");
      out.write("                        <strong>登录密码</strong>\n");
      out.write("                        <hr>\n");
      out.write("                        <div class=\"form-group\">\n");
      out.write("                            <input type=\"password\" class=\"form-control\" placeholder=\"旧登录密码\" id=\"oPassWard\" name=\"oPassWard\">\n");
      out.write("                        </div>\n");
      out.write("                        <hr>\n");
      out.write("                        <div class=\"form-group\">\n");
      out.write("                            <input type=\"password\" class=\"form-control\" placeholder=\"新登录密码\" id=\"nPassWard\" name=\"nPassWard\">\n");
      out.write("                        </div>\n");
      out.write("                        <hr>\n");
      out.write("                        <div class=\"form-group\">\n");
      out.write("                            <input type=\"password\" class=\"form-control\" placeholder=\"重复登录密码\" id=\"rPassWard\" name=\"rPassWard\">\n");
      out.write("                        </div>\n");
      out.write("                        <hr>\n");
      out.write("                    </div>\n");
      out.write("                </div>\n");
      out.write("                <div class=\"col-lg-6\">\n");
      out.write("                    <div class=\"alert alert-info\" role=\"alert\" style=\"width: 100%;text-align: center\">\n");
      out.write("                        <strong>安全密码</strong>\n");
      out.write("                        <hr>\n");
      out.write("                        <div class=\"form-group\">\n");
      out.write("                            <input type=\"password\" class=\"form-control\" placeholder=\"旧安全密码\" id=\"oPassWard1\" name=\"oPassWard1\">\n");
      out.write("                        </div>\n");
      out.write("                        <hr>\n");
      out.write("                        <div class=\"form-group\">\n");
      out.write("                            <input type=\"password\" class=\"form-control\" placeholder=\"新安全密码\" id=\"nPassWard1\" name=\"nPassWard1\">\n");
      out.write("                        </div>\n");
      out.write("                        <hr>\n");
      out.write("                        <div class=\"form-group\">\n");
      out.write("                            <input type=\"password\" class=\"form-control\" placeholder=\"重复安全密码\" id=\"rPassWard1\" name=\"rPassWard1\">\n");
      out.write("                        </div>\n");
      out.write("                        <hr>\n");
      out.write("                    </div>\n");
      out.write("                </div>\n");
      ...
      out.write("                <button type=\"submit\" class=\"btn btn-primary col-md-4 col-md-offset-4\">确定</button></div>\n");
      out.write("        </form>\n");
      out.write("    </div>\n");
      out.write("</div>\n");
      ...
      out.write("                live: 'disabled',//验证时机，enabled是内容有变化就验证（默认），disabled和submitted是提交再验证\n");
      out.write("                excluded: [':disabled', ':hidden', ':not(:visible)'],//排除无需验证的控件，比如被禁用的或者被隐藏的\n");
      out.write("                message: '通用的验证失败消息',//好像从来没出现过\n");
      out.write("                fields: {\n");
      out.write("                    oPassWard: {\n");
      out.write("                        validators: {\n");
      out.write("                            notEmpty: {\n");
      out.write("                                message: '旧登录密码不能为空'\n");
      out.write("                            }\n");
      out.write("                        }\n");
      out.write("                    },\n");
      out.write("                    oPassWard1: {\n");
      out.write("                        validators: {\n");
      out.write("                            notEmpty: {\n");
      out.write("                                message: '旧安全密码不能为空'\n");
      out.write("                            }\n");
      out.write("                        }\n");
      out.write("                    },\n");
      out.write("                    nPassWard: {\n");
      out.write("                        validators: {\n");
      out.write("                            notEmpty: {\n");
      out.write("                                message: '新登录密码不能为空'\n");
      out.write("                            },\n");
      out.write("                            stringLength: {//检测长度\n");
      out.write("                                min: 6,\n");
      out.write("                                max: 30,\n");
      out.write("                                message: '长度必须在6-30之间'\n");
      out.write("                            },\n");
      out.write("                            regexp: {//正则验证\n");
      out.write("                                regexp: /^[a-zA-Z0-9_\\.]+$/,\n");
      out.write("                                message: '只能输入字母、数字、下划线和点'\n");
      out.write("                            }\n");
      out.write("                        }\n");
      out.write("                    },\n");
      out.write("                    nPassWard1: {\n");
      out.write("                        validators: {\n");
      out.write("                            notEmpty: {\n");
      out.write("                                message: '新安全密码不能为空'\n");
      out.write("                            },\n");
      out.write("                            stringLength: {//检测长度\n");
      out.write("                                min: 6,\n");
      out.write("                                max: 30,\n");
      ...
      out.write("                        validators: {\n");
      out.write("                            notEmpty: {\n");
      out.write("                                message: '新重复登录密码不能为空'\n");
      out.write("                            },\n");
      out.write("                            identical: {\n");
      out.write("                                field: 'nPassWard',\n");
      out.write("                                message: '新登录密码两次输入的不一致'\n");
      out.write("                            }\n");
      out.write("                        }\n");
      out.write("                    },\n");
      out.write("                    rPassWard1: {\n");
      out.write("                        validators: {\n");
      out.write("                            notEmpty: {\n");
      out.write("                                message: '新重复安全密码不能为空'\n");
      out.write("                            },\n");
      out.write("                            identical: {\n");
      out.write("                                field: 'nPassWard1',\n");
      out.write("                                message: '新安全密码两次输入的不一致'\n");
      out.write("                            }\n");
      out.write("                        }\n");
      out.write("                    }\n");
      out.write("                }\n");
      ...
      out.write("            }\n");
      out.write("            // 提交信息\n");
      out.write("            var url=\"frontUserRegisterController.do?doUpdatePwd\";\n");
      out.write("            var fromData = $('#updpwdForm').serialize();\n");
      out.write("            $.ajax({\n");
