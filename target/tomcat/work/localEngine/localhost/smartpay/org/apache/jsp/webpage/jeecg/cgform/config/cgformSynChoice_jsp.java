...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path;
      ...
      if (_jspx_meth_t_005fbase_005f0(_jspx_page_context))
        return;
      out.write("\n");
      out.write("<!-- update--begin--author:zhangjiaqiang date:20170526 for:TASK #2008 【样式改进】同步数据库下面这个去掉 -->\n");
      out.write("<style>\n");
      out.write("<!--\n");
      out.write("body{\n");
      ...
      out.write("-->\n");
      out.write("</style>\n");
      out.write("<!-- update--end--author:zhangjiaqiang date:20170526 for:TASK #2008 【样式改进】同步数据库下面这个去掉 -->\n");
      out.write("<div>\n");
  ...
  private boolean _jspx_meth_t_005fmutiLang_005f0(PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/config/cgformSynChoice.jsp(15,65) name = langKey type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_t_005fmutiLang_005f1(PageContext _jspx_page_context)
    ...
    // /webpage/jeecg/cgform/config/cgformSynChoice.jsp(16,56) name = langKey type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
