...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="div" action="frontUserActivatecodeController.do?doAdd" >
		...
		<fieldset class="step">
			...
			<div class="form">
		      <label class="Validform_label">激活码:</label>
					     	 <input id="activieCode" name="activieCode" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
		      <label class="Validform_label">购买时间:</label>
					     	 <input id="buyTime" name="buyTime" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
		      <label class="Validform_label">使用时间:</label>
					  <input id="useTime" name="useTime" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()"  ignore="ignore" />
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
		      <label class="Validform_label">使用人:</label>
					     	 <input id="userUsername" name="userUsername" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
		      <label class="Validform_label">是否使用:</label>
					  <input id="isuse" name="isuse" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()"  ignore="ignore" />
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
		      <label class="Validform_label">是否有效:</label>
					  <input id="validstatus" name="validstatus" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()"  ignore="ignore" />
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
		      <label class="Validform_label">激活码类型:</label>
				 <textarea id="activieType" style="width:600px;" class="inputxt" rows="6" name="activieType"  ignore="ignore" ></textarea>
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
