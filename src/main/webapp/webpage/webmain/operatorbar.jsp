...
<div class="container" id="operatorbar">
    <div class="row" style="padding-top: 10px;color: white">
        ...
        <div class="col-lg-4">
            <div class="col-sm-4 col-xs-4" style="text-align: center">
                <a href="frontUserActivatecodeController.do?activatecode">
                    <img class="img-circle navImg" src="plug-in/webfront/images/activate.png"></a>
                <h5><strong>激活码管理</strong></h5>
            </div>
            <div class="col-sm-4 col-xs-4" style="text-align: center">
                <a href="tSFeedbackController.do?toFeedback">
                    <img class="img-circle navImg" src="plug-in/webfront/images/pro.png"></a>
                <h5><strong>问题反馈</strong></h5>
            </div>
            <div class="col-sm-4 col-xs-4" style="text-align: center">
                <a href="tSUsernoticeController.do?toNoticeList">
