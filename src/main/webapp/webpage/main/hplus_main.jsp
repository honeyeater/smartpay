...
<div id="wrapper">
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <%--dangzhenghui begin 20170502 for 增加添加头像功能--%>
                                <span><img alt="image" width="180" height="61" src="plug-in/login/images/trade3-icon.png" /></span>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <style type="text/css">  
		<!--  
		.proccess{display:none;background-color:#f2f2f2;border:0px solid;border-color:#009900;height:100%;line-height:600px;width:100%;text-align:center;margin:100px;position:absolute;top:0;left:0;}
        ...
        <div class="footer" style="border-top:none;">
            <div class="pull-right">&copy; <t:mutiLang langKey="system.version.number"/> <a href="http://www.goldspay.org/" target="_blank">smartpay</a>
            </div>
        </div>        
