 ...
 * @version 1.0
 */
public class FrontClient implements java.io.Serializable {

	private static final long serialVersionUID = 1L;

	private FrontUserRegisterEntity user;
    ...
    public FrontUserRegisterEntity getUser() {
        return user;
    }

    public void setUser(FrontUserRegisterEntity user) {
        this.user = user;
    }
}
