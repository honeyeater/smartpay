 ...
 */
@Entity
@Table(name = "log_trade_info", schema = "")
@SuppressWarnings("serial")
public class LogTradeInfoEntity implements java.io.Serializable {
	/**ID*/
	...
	/**静态奖金*/
    @Excel(name="静态奖金",width=15)
	private java.lang.Double staticMoney;
	/**动态奖金*/
    @Excel(name="动态奖金",width=15)
	private java.lang.Double dynMoney;
	/**其他奖金*/
    @Excel(name="其他奖金",width=15)
	private java.lang.Double otherMoney;
	/**待返金额*/
    @Excel(name="待返金额",width=15)
	private java.lang.Double backMoney;
	/**释放钱包*/
	 ...
	 *@return: java.lang.Double  静态奖金
	 */
	@Column(name ="STATIC_MONEY",nullable=true,scale=3,length=15)
	public java.lang.Double getStaticMoney(){
		return this.staticMoney;
	}

	/**
	 *方法: 设置java.lang.Double
	 *@param: java.lang.Double  静态奖金
	 */
	public void setStaticMoney(java.lang.Double staticMoney){
	...
	public java.lang.Double getDynMoney(){
	 ...
	 */
	public void setDynMoney(java.lang.Double dynMoney){
	...
	public java.lang.Double getBackMoney(){
	 ...
	 */
	public void setBackMoney(java.lang.Double backMoney){
	...
	public java.lang.Double getReleaseMoney(){
	 ...
	 */
	public void setReleaseMoney(java.lang.Double releaseMoney){
